    ...
    <el-row>
      <el-col :span="24">
        <el-form ref="screenFrom" :inline="true" size="medium" :model="formData" class="screen-from toolbar">
          <el-form-item>
            <el-input v-model="formData.load_name" placeholder="请输入借款人姓名" clearable />
          </el-form-item>
          <el-form-item>
            <el-input v-model="formData.repay_name" placeholder="请输入还款人姓名" clearable />
          </el-form-item>
          <el-form-item>
            <el-input v-model="formData.capitalNum" :placeholder="placeholderObj.type" class="input-with-select">
              <el-select slot="prepend" v-model="formData.type" placeholder="资金类型" @change="changeCapitalType">
                <el-option
